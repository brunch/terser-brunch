...
module.exports = UglifyMinifier = (function() {
  ...
  UglifyMinifier.prototype.optimize = function(data, path, callback) {
    var err, error, optimized, result, _ref, _ref1;
    this.options.outSourceMap = ((_ref = this.options) != null ? _ref.sourceMaps : void 0) ? "" + path + ".map" : void 0;
    try {
      ...
      result = optimized && ((_ref1 = this.options) != null ? _ref1.sourceMaps : void 0) ? {
        data: optimized.code,
        map: optimized.map
      } : {
        data: optimized.code
